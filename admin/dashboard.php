...
<div class="row g-4">
    ...
    <div class="col-md-3">
        <div class="card p-4 text-center">
            <h1 class="display-5 fw-bold text-warning"><?= count(loadData('reviews.json')) ?></h1>
    ...
    <div class="col-md-6">
        <div class="card p-4">
            ...
            <div class="d-grid gap-2">
                ...
                <a href="admin.php?action=reviews" class="btn btn-outline-warning text-start"><i class="bi bi-eye me-2"></i> Manage Reviews</a>
