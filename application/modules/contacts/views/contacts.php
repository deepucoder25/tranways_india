...
<section class="hs-main-section pb-5 bg-light position-relative">
  ...
  <div class="container position-relative">
    ...
    <div class="row g-4 mb-5">
      ...
      <div class="col-lg-4 col-md-6">
        <div class="hs-card-premium bg-white rounded-4 shadow p-4 text-center h-100 border-0">
          <div class="hs-icon-box bg-orange text-white rounded-circle d-inline-flex align-items-center justify-content-center mb-3 shadow-sm">
            <i class="bi bi-geo-alt-fill fs-3"></i>
          </div>
          <h5 class="mb-2 text-dark">Office Location</h5>
      ...
      <div class="col-lg-4 col-md-6">
        <div class="hs-card-premium bg-white rounded-4 shadow p-4 text-center h-100 border-0">
          <div class="hs-icon-box bg-primary-blue text-white rounded-circle d-inline-flex align-items-center justify-content-center mb-3 shadow-sm position-relative">
            <i class="bi bi-telephone-fill fs-3 hs-animated-ring"></i>
          </div>
          <h5 class="mb-2 text-dark">Call Us 24/7</h5>
      ...
      <div class="col-lg-4 col-md-6">
        <div class="hs-card-premium bg-white rounded-4 shadow p-4 text-center h-100 border-0">
          ...
          <h5 class="mb-2 text-dark">Email Support</h5>
      ...
      <div class="col-lg-7">
        <div class="hs-card-premium bg-white rounded-4 shadow-sm p-4 p-md-5 h-100 border-top border-4 border-primary-blue">
          <div class="d-flex align-items-center mb-4">
            ...
            <h3 class="text-dark mb-0">Drop Us A <span class="text-primary-blue">Message</span></h3>
          </div>
          ...
          <form id="getintouchform" class="ajax-form row g-4" data-url="<?php echo site_url('contacts/contact'); ?>" data-result="resulttouch" onsubmit="return false;">
            ...
            <div class="col-12 form_box mt-4">
              <button type="submit" id="submitcontactbtn" class="btn btn-orange text-white rounded-3 px-5 py-3 fw-bold shadow-sm w-100 hs-btn-pulse border-0 fs-5 text-uppercase letter-spacing-1">
