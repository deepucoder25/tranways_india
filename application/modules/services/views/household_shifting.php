    ...
    <div class="row g-5">
      ...
      <div class="col-lg-8">
        ...
        <div class="hs-card-premium bg-white rounded-4 shadow-sm p-4 p-md-5 mb-5 position-relative border-0">
          <div class="hs-premium-badge">Top Rated Service</div>
          <img src="<?= base_url('assets/images/services/household_hero.png') ?>" alt="<?= $company3 ?> Household Shifting" class="img-fluid rounded-4 mb-4 w-100 object-fit-cover shadow" style="max-height: 450px;" loading="lazy">
          
          <h2 class="display-6 fw-bold text-dark mb-4">Experience Stress-Free <span class="text-primary-blue">Household Shifting</span></h2>
          <p class="text-muted fs-5 mb-4 lh-lg">
            Relocating your familyâ€™s memories requires more than just transport; it requires care, precision, and trust. At <strong><?= $company3 ?></strong>, our end-to-end household shifting solutions are designed to provide a completely stress-free experience. From careful packing of your delicate items to safe transportation and unpacking, we handle every detail so you can focus on your new beginning.
          </p>
          ...
          <div class="row g-4 mt-3">
            <div class="col-md-6">
              <div class="hs-feature-box d-flex align-items-center p-3 rounded-3 border">
                ...
                <div>
                  <h5 class="fw-bold mb-1">100% Safe Transit</h5>
                  <p class="text-muted small mb-0">Zero damage guarantee.</p>
                </div>
              </div>
            </div>
            <div class="col-md-6">
              <div class="hs-feature-box d-flex align-items-center p-3 rounded-3 border">
                ...
                <div>
                  <h5 class="fw-bold mb-1">Premium Packing</h5>
                  <p class="text-muted small mb-0">3-layer bubble wrapping.</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="row g-4 hs-process-grid">
            <div class="col-sm-6">
              <div class="hs-process-box p-4 rounded-4 bg-light h-100 position-relative overflow-hidden">
                ...
                <h5 class="fw-bold text-dark position-relative z-index-2">Free Survey</h5>
                <p class="text-muted small mb-0 position-relative z-index-2">Detailed inspection and customized estimation without hidden costs.</p>
              </div>
            </div>
            <div class="col-sm-6">
              <div class="hs-process-box p-4 rounded-4 bg-light h-100 position-relative overflow-hidden">
                <div class="hs-process-num">02</div>
                <h5 class="fw-bold text-dark position-relative z-index-2">Secure Packing</h5>
                <p class="text-muted small mb-0 position-relative z-index-2">Premium materials used by trained professionals to pack items securely.</p>
              </div>
            </div>
            <div class="col-sm-6">
              <div class="hs-process-box p-4 rounded-4 bg-light h-100 position-relative overflow-hidden">
                <div class="hs-process-num">03</div>
                <h5 class="fw-bold text-dark position-relative z-index-2">Safe Transit</h5>
                <p class="text-muted small mb-0 position-relative z-index-2">GPS-enabled enclosed trucks ensure weather-proof, safe delivery.</p>
              </div>
            </div>
            <div class="col-sm-6">
              <div class="hs-process-box p-4 rounded-4 bg-light h-100 position-relative overflow-hidden">
                <div class="hs-process-num">04</div>
                <h5 class="fw-bold text-dark position-relative z-index-2">Unpack & Setup</h5>
                <p class="text-muted small mb-0 position-relative z-index-2">We unload, unpack, and arrange your furniture at the new destination.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="hs-card-premium bg-white rounded-4 shadow-sm p-4 p-md-5 mb-5 border-0">
          ...
          <div class="row g-4">
            <div class="col-md-6">
              <div class="hs-review-card bg-light p-4 rounded-4 h-100">
                <div class="d-flex text-warning mb-2">
                  <i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i>
                </div>
                <p class="fst-italic text-muted small mb-3">"Amazing service! They packed all my glassware perfectly. Not a single scratch during my move from Delhi to Bangalore."</p>
                <div class="d-flex align-items-center">
                  <div class="hs-reviewer-avatar bg-primary-blue text-white rounded-circle d-flex align-items-center justify-content-center fw-bold me-3">R</div>
                  <div>
                    <h6 class="fw-bold mb-0">Rahul Sharma</h6>
                    <span class="small text-muted">Delhi</span>
                  </div>
                </div>
              </div>
            </div>
            <div class="col-md-6">
              <div class="hs-review-card bg-light p-4 rounded-4 h-100">
                ...
                <p class="fst-italic text-muted small mb-3">"The team arrived on time and handled heavy furniture with ease. Very professional and polite staff. Highly recommended!"</p>
                <div class="d-flex align-items-center">
                  <div class="hs-reviewer-avatar bg-orange text-white rounded-circle d-flex align-items-center justify-content-center fw-bold me-3">A</div>
                  <div>
                    <h6 class="fw-bold mb-0">Anita Desai</h6>
                    <span class="small text-muted">Mumbai</span>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class="hs-card-premium bg-white rounded-4 shadow-sm p-4 p-md-5 mb-5 border-0">
          ...
          <div class="accordion hs-accordion" id="hsFaqAccordion">
            <div class="accordion-item border-0 mb-3 rounded-3 shadow-sm overflow-hidden">
              <h2 class="accordion-header">
                <button class="accordion-button fw-bold bg-white text-dark" type="button" data-bs-toggle="collapse" data-bs-target="#hsFaq1">
                  How much time does household shifting take?
                </button>
              </h2>
              <div id="hsFaq1" class="accordion-collapse collapse show" data-bs-parent="#hsFaqAccordion">
                <div class="accordion-body text-muted small">
                  The time required depends on the volume of goods and the distance. Local shifting within the city usually takes 1 day, whereas domestic shifting can take 3 to 7 days depending on the transit distance.
                </div>
              </div>
            </div>
            ...
            <div class="accordion-item border-0 mb-3 rounded-3 shadow-sm overflow-hidden">
              <h2 class="accordion-header">
                <button class="accordion-button collapsed fw-bold bg-white text-dark" type="button" data-bs-toggle="collapse" data-bs-target="#hsFaq2">
                  Do you provide insurance for my household goods?
                </button>
              </h2>
              <div id="hsFaq2" class="accordion-collapse collapse" data-bs-parent="#hsFaqAccordion">
                <div class="accordion-body text-muted small">
                  Yes! We offer comprehensive transit insurance to ensure that in the rare event of an accident or unforeseen circumstance, your valuable belongings are fully financially protected.
                </div>
              </div>
            </div>
            ...
            <div class="accordion-item border-0 rounded-3 shadow-sm overflow-hidden">
              <h2 class="accordion-header">
                <button class="accordion-button collapsed fw-bold bg-white text-dark" type="button" data-bs-toggle="collapse" data-bs-target="#hsFaq3">
                  Do I need to pack anything myself?
                </button>
              </h2>
              <div id="hsFaq3" class="accordion-collapse collapse" data-bs-parent="#hsFaqAccordion">
                <div class="accordion-body text-muted small">
                  No, our expert team handles complete end-to-end packing. We bring all necessary materials like bubble wrap, cartons, and corrugated sheets. You only need to keep your personal documents and jewelry with you.
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="col-lg-4">
        <div class="position-sticky hs-sidebar-wrapper" style="top: 100px;">
          ...
          <!-- Content Related Widget: Our Guarantees (Replacing the Form) -->
          ...
          <!-- Help / Contact Card -->
          <div class="hs-sidebar-widget hs-help-card bg-orange text-white rounded-4 shadow p-4 py-4 text-center position-relative overflow-hidden">
            <div class="hs-help-pattern position-absolute opacity-25">
