<?php $this->load->view('template/inner_hero', ['page_title' => 'Domestic Shifting', 'parent_title' => 'Services', 'parent_link' => 'services', 'bg_image' => 'assets/images/services/domestic_shifting_hero.png']); ?>
    ...
    <div class="row g-5">
      ...
      <div class="col-lg-8">
        ...
        <div class="hs-card-premium bg-white rounded-4 shadow-sm p-4 p-md-5 mb-5 position-relative border-0">
          <div class="hs-premium-badge">Nationwide Coverage</div>
          <img src="<?= base_url('assets/images/services/domestic_shifting_hero.png') ?>" alt="<?= $company3 ?> Domestic Shifting" class="img-fluid rounded-4 mb-4 w-100 object-fit-cover shadow" style="max-height: 450px;" loading="lazy">
          
          <h2 class="display-6 fw-bold text-dark mb-4">Long Distance <span class="text-primary-blue">Domestic Shifting</span></h2>
          <p class="text-muted fs-5 mb-4 lh-lg">
            Moving to a completely new state requires meticulous planning, robust logistics, and a highly trusted partner. <strong><?= $company3 ?></strong> provides end-to-end interstate domestic shifting services. With our extensive nationwide network, dedicated fleet of large enclosed carriers, and rigorous quality checks, we ensure your belongings traverse thousands of kilometers with zero damage.
          </p>
            ...
            <div class="col-md-6">
              <div class="hs-feature-box d-flex align-items-center p-3 rounded-3 border">
                ...
                <div>
                  ...
                  <p class="text-muted small mb-0">GPS tracking across India.</p>
                </div>
              </div>
            </div>
            <div class="col-md-6">
              <div class="hs-feature-box d-flex align-items-center p-3 rounded-3 border">
                ...
                <div>
                  <h5 class="fw-bold mb-1">Transit Insurance</h5>
                  <p class="text-muted small mb-0">Full coverage for interstate moves.</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="row g-4 hs-process-grid">
            <div class="col-sm-6">
              <div class="hs-process-box p-4 rounded-4 bg-light h-100 position-relative overflow-hidden">
                ...
                <h5 class="fw-bold text-dark position-relative z-index-2">Consultation</h5>
                <p class="text-muted small mb-0 position-relative z-index-2">We discuss your move date, distance, and inventory to create a detailed logistic plan.</p>
              </div>
            </div>
            <div class="col-sm-6">
              <div class="hs-process-box p-4 rounded-4 bg-light h-100 position-relative overflow-hidden">
                <div class="hs-process-num">02</div>
                <h5 class="fw-bold text-dark position-relative z-index-2">Heavy-Duty Packing</h5>
                <p class="text-muted small mb-0 position-relative z-index-2">Interstate moves require extra padding. We use multi-layer crating for maximum safety.</p>
              </div>
            </div>
            <div class="col-sm-6">
              <div class="hs-process-box p-4 rounded-4 bg-light h-100 position-relative overflow-hidden">
                <div class="hs-process-num">03</div>
                <h5 class="fw-bold text-dark position-relative z-index-2">Long Haul Transit</h5>
                <p class="text-muted small mb-0 position-relative z-index-2">Our large, heavy-duty commercial trucks transport your goods smoothly across states.</p>
              </div>
            </div>
            <div class="col-sm-6">
              <div class="hs-process-box p-4 rounded-4 bg-light h-100 position-relative overflow-hidden">
                <div class="hs-process-num">04</div>
                <h5 class="fw-bold text-dark position-relative z-index-2">Destination Setup</h5>
                <p class="text-muted small mb-0 position-relative z-index-2">Our destination branch team receives the truck, unloads, and unpacks your belongings.</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="row g-4">
            <div class="col-md-6">
              <div class="hs-review-card bg-light p-4 rounded-4 h-100">
                ...
                <p class="fst-italic text-muted small mb-3">"Moving from Delhi to Chennai seemed like a nightmare, but Transways India made it feel effortless. The GPS tracking kept me calm the entire 4 days."</p>
                <div class="d-flex align-items-center">
                  <div class="hs-reviewer-avatar bg-primary-blue text-white rounded-circle d-flex align-items-center justify-content-center fw-bold me-3">A</div>
                  <div>
                    <h6 class="fw-bold mb-0">Amitabh Rai</h6>
                    <span class="small text-muted">IT Professional</span>
                  </div>
                </div>
              </div>
            </div>
            <div class="col-md-6">
              <div class="hs-review-card bg-light p-4 rounded-4 h-100">
                ...
                <p class="fst-italic text-muted small mb-3">"Excellent packaging. Not a single glass broke during the 1500km journey. The unpacking team at the destination was just as professional as the packing team."</p>
                <div class="d-flex align-items-center">
                  ...
                  <div>
                    <h6 class="fw-bold mb-0">Meera Das</h6>
                    <span class="small text-muted">Homemaker</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="accordion-item border-0 mb-3 rounded-3 shadow-sm overflow-hidden">
              ...
              <div id="hsFaq1" class="accordion-collapse collapse show" data-bs-parent="#hsFaqAccordion">
                <div class="accordion-body text-muted small">
                  The delivery timeline depends primarily on the distance. On average, a domestic move across major states takes between 3 to 7 days. We provide a detailed schedule before the move.
                </div>
              </div>
            </div>
            ...
            <div class="accordion-item border-0 mb-3 rounded-3 shadow-sm overflow-hidden">
              <h2 class="accordion-header">
                <button class="accordion-button collapsed fw-bold bg-white text-dark" type="button" data-bs-toggle="collapse" data-bs-target="#hsFaq2">
                  Who unloads my items at the destination state?
                </button>
              </h2>
              <div id="hsFaq2" class="accordion-collapse collapse" data-bs-parent="#hsFaqAccordion">
                <div class="accordion-body text-muted small">
                  Since we have a nationwide network, our local branch team at your destination city will receive the truck, carefully unload your goods, and assist with complete unpacking.
                </div>
              </div>
            </div>
          </div>
      ...
      <!-- Sidebar Col (4) -->
      <div class="col-lg-4">
        <div class="position-sticky hs-sidebar-wrapper" style="top: 150px;">
          ...
          <div class="hs-sidebar-widget bg-white rounded-4 shadow-sm p-4 mb-4 border border-light">
            ...
            <ul class="list-unstyled hs-services-list mb-0">
              ...
              <li><a href="<?= site_url('services/domestic-shifting') ?>" class="active">Domestic Shifting <i class="bi bi-chevron-right"></i></a></li>
