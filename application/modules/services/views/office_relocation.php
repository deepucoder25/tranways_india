    ...
    <div class="row g-5">
      ...
      <div class="col-lg-8">
        ...
        <div class="hs-card-premium bg-white rounded-4 shadow-sm p-4 p-md-5 mb-5 position-relative border-0">
          ...
          <h2 class="display-6 fw-bold text-dark mb-4">Seamless & Secure <span class="text-primary-blue">Office Relocation</span></h2>
          ...
          <div class="row g-4 mt-3">
            <div class="col-md-6">
              <div class="hs-feature-box d-flex align-items-center p-3 rounded-3 border">
                ...
                <div>
                  <h5 class="fw-bold mb-1">IT Equipment Safety</h5>
                  <p class="text-muted small mb-0">Anti-static packing for servers.</p>
                </div>
              </div>
            </div>
            <div class="col-md-6">
              <div class="hs-feature-box d-flex align-items-center p-3 rounded-3 border">
                ...
                <div>
                  <h5 class="fw-bold mb-1">Weekend Moves</h5>
                  <p class="text-muted small mb-0">Relocate outside business hours.</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="row g-4 hs-process-grid">
            <div class="col-sm-6">
              <div class="hs-process-box p-4 rounded-4 bg-light h-100 position-relative overflow-hidden">
                ...
                <h5 class="fw-bold text-dark position-relative z-index-2">Site Evaluation</h5>
                <p class="text-muted small mb-0 position-relative z-index-2">We analyze your current and new office spaces to plan logistics perfectly.</p>
              </div>
            </div>
            <div class="col-sm-6">
              <div class="hs-process-box p-4 rounded-4 bg-light h-100 position-relative overflow-hidden">
                <div class="hs-process-num">02</div>
                <h5 class="fw-bold text-dark position-relative z-index-2">Systematic Packing</h5>
                <p class="text-muted small mb-0 position-relative z-index-2">Color-coded labeling system to ensure desks and IT gear stay organized.</p>
              </div>
            </div>
            <div class="col-sm-6">
              <div class="hs-process-box p-4 rounded-4 bg-light h-100 position-relative overflow-hidden">
                <div class="hs-process-num">03</div>
                <h5 class="fw-bold text-dark position-relative z-index-2">Secure Transit</h5>
                <p class="text-muted small mb-0 position-relative z-index-2">Air-ride suspension trucks to safely transport highly sensitive electronics.</p>
              </div>
            </div>
            <div class="col-sm-6">
              <div class="hs-process-box p-4 rounded-4 bg-light h-100 position-relative overflow-hidden">
                <div class="hs-process-num">04</div>
                <h5 class="fw-bold text-dark position-relative z-index-2">Quick Reassembly</h5>
                <p class="text-muted small mb-0 position-relative z-index-2">Desks and workstations are reassembled exactly as planned, ready for work.</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="row g-4">
            <div class="col-md-6">
              <div class="hs-review-card bg-light p-4 rounded-4 h-100">
                ...
                <p class="fst-italic text-muted small mb-3">"We relocated our 50-employee IT firm over the weekend. Come Monday morning, all servers and PCs were online. Incredible service!"</p>
                <div class="d-flex align-items-center">
                  ...
                  <div>
                    <h6 class="fw-bold mb-0">Sanjay Gupta</h6>
                    <span class="small text-muted">IT Director</span>
                  </div>
                </div>
              </div>
            </div>
            <div class="col-md-6">
              <div class="hs-review-card bg-light p-4 rounded-4 h-100">
                ...
                <p class="fst-italic text-muted small mb-3">"Very organized crew. The color-coding system they used made sure no files or employee belongings were mixed up."</p>
                <div class="d-flex align-items-center">
                  <div class="hs-reviewer-avatar bg-orange text-white rounded-circle d-flex align-items-center justify-content-center fw-bold me-3">P</div>
                  <div>
                    <h6 class="fw-bold mb-0">Priya Mehta</h6>
                    <span class="small text-muted">HR Manager</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="accordion-item border-0 mb-3 rounded-3 shadow-sm overflow-hidden">
              ...
              <div id="hsFaq1" class="accordion-collapse collapse show" data-bs-parent="#hsFaqAccordion">
                <div class="accordion-body text-muted small">
                  Absolutely. We understand that business hours are critical. We specialize in overnight and weekend relocations to ensure zero operational downtime for your company.
                </div>
              </div>
            </div>
            ...
            <div class="accordion-item border-0 mb-3 rounded-3 shadow-sm overflow-hidden">
              <h2 class="accordion-header">
                <button class="accordion-button collapsed fw-bold bg-white text-dark" type="button" data-bs-toggle="collapse" data-bs-target="#hsFaq2">
                  Do you handle server racks and heavy IT equipment?
                </button>
              </h2>
              <div id="hsFaq2" class="accordion-collapse collapse" data-bs-parent="#hsFaqAccordion">
                <div class="accordion-body text-muted small">
                  Yes, we use anti-static packing materials and specialized moving equipment to safely dismantle, transport, and reassemble heavy server racks and delicate IT infrastructure.
                </div>
              </div>
            </div>
          </div>
