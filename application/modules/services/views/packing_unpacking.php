    ...
    <div class="row g-5">
      ...
      <div class="col-lg-8">
        ...
        <div class="hs-card-premium bg-white rounded-4 shadow-sm p-4 p-md-5 mb-5 position-relative border-0">
          ...
          <h2 class="display-6 text-dark mb-4">Professional <span class="text-primary-blue">Packing & Unpacking</span></h2>
          ...
          <div class="row g-4 mt-3">
            <div class="col-md-6">
              <div class="hs-feature-box d-flex align-items-center p-3 rounded-3 border">
                ...
                <div>
                  <h5 class="mb-1">Premium Materials</h5>
            ...
            <div class="col-md-6">
              <div class="hs-feature-box d-flex align-items-center p-3 rounded-3 border">
                ...
                <div>
                  <h5 class="mb-1">Smart Labeling</h5>
          ...
          <div class="row g-4 hs-process-grid">
            <div class="col-sm-6">
              <div class="hs-process-box p-4 rounded-4 bg-light h-100 position-relative overflow-hidden">
                ...
                <h5 class="text-dark position-relative z-index-2">Assessment</h5>
            ...
            <div class="col-sm-6">
              <div class="hs-process-box p-4 rounded-4 bg-light h-100 position-relative overflow-hidden">
                ...
                <h5 class="text-dark position-relative z-index-2">Careful Packing</h5>
            ...
            <div class="col-sm-6">
              <div class="hs-process-box p-4 rounded-4 bg-light h-100 position-relative overflow-hidden">
                ...
                <h5 class="text-dark position-relative z-index-2">Inventory Logging</h5>
            ...
            <div class="col-sm-6">
              <div class="hs-process-box p-4 rounded-4 bg-light h-100 position-relative overflow-hidden">
                ...
                <h5 class="text-dark position-relative z-index-2">Unpacking Setup</h5>
          ...
          <div class="row g-4">
            <div class="col-md-6">
              <div class="hs-review-card bg-light p-4 rounded-4 h-100">
                ...
                <div class="d-flex align-items-center">
                  <div class="hs-reviewer-avatar bg-primary-blue text-white rounded-circle d-flex align-items-center justify-content-center me-3">A</div>
                  <div>
                    <h6 class="mb-0">Aditi Varma</h6>
            ...
            <div class="col-md-6">
              <div class="hs-review-card bg-light p-4 rounded-4 h-100">
                ...
                <div class="d-flex align-items-center">
                  <div class="hs-reviewer-avatar bg-orange text-white rounded-circle d-flex align-items-center justify-content-center me-3">K</div>
                  <div>
                    <h6 class="mb-0">Karan Patel</h6>
