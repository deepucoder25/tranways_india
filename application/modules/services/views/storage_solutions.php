          ...
          <div class="row g-4 mt-3">
            <div class="col-md-6">
              <div class="hs-feature-box d-flex align-items-center p-3 rounded-3 border">
                ...
                <div>
                  <h5 class="mb-1">24/7 Surveillance</h5>
                  <p class="text-muted small mb-0">Continuous CCTV monitoring.</p>
                </div>
              </div>
            </div>
            <div class="col-md-6">
              <div class="hs-feature-box d-flex align-items-center p-3 rounded-3 border">
                ...
                <div>
                  <h5 class="mb-1">Climate Controlled</h5>
                  <p class="text-muted small mb-0">Protection from extreme weather.</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="row g-4 hs-process-grid">
            <div class="col-sm-6">
              <div class="hs-process-box p-4 rounded-4 bg-light h-100 position-relative overflow-hidden">
                ...
                <h5 class="text-dark position-relative z-index-2">Item Assessment</h5>
                <p class="text-muted small mb-0 position-relative z-index-2">We analyze the volume of goods to allocate the perfect storage space.</p>
              </div>
            </div>
            <div class="col-sm-6">
              <div class="hs-process-box p-4 rounded-4 bg-light h-100 position-relative overflow-hidden">
                ...
                <p class="text-muted small mb-0 position-relative z-index-2">Items are packed specifically for long-term storage to prevent moisture damage.</p>
              </div>
            </div>
            <div class="col-sm-6">
              <div class="hs-process-box p-4 rounded-4 bg-light h-100 position-relative overflow-hidden">
                ...
                <p class="text-muted small mb-0 position-relative z-index-2">A detailed inventory receipt is generated so you know exactly what is stored.</p>
              </div>
            </div>
            <div class="col-sm-6">
              <div class="hs-process-box p-4 rounded-4 bg-light h-100 position-relative overflow-hidden">
                <div class="hs-process-num">04</div>
                <h5 class="text-dark position-relative z-index-2">Safe Return</h5>
                <p class="text-muted small mb-0 position-relative z-index-2">When you're ready, we safely deliver and unpack your items at your doorstep.</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="row g-4">
            <div class="col-md-6">
              <div class="hs-review-card bg-light p-4 rounded-4 h-100">
                ...
                <p class="fst-italic text-muted small mb-3">"I stored my household items for 6 months while working abroad. Everything was returned to me in the exact same condition I left it."</p>
                <div class="d-flex align-items-center">
                  ...
                  <div>
                    <h6 class="mb-0">Rajat Sharma</h6>
                    <span class="small text-muted">Expat</span>
                  </div>
                </div>
              </div>
            </div>
            <div class="col-md-6">
              <div class="hs-review-card bg-light p-4 rounded-4 h-100">
                ...
                <p class="fst-italic text-muted small mb-3">"Highly secure facility. I visited their warehouse before booking and was incredibly impressed by the cleanliness and security measures."</p>
                <div class="d-flex align-items-center">
                  <div class="hs-reviewer-avatar bg-orange text-white rounded-circle d-flex align-items-center justify-content-center me-3">T</div>
                  <div>
                    <h6 class="mb-0">Tanya Reddy</h6>
                    <span class="small text-muted">Interior Designer</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="accordion-item border-0 mb-3 rounded-3 shadow-sm overflow-hidden">
              ...
              <div id="hsFaq1" class="accordion-collapse collapse show" data-bs-parent="#hsFaqAccordion">
                <div class="accordion-body text-muted small">
                  We offer highly flexible storage solutions. You can store your items for as little as a week or for several years depending on your requirement.
                </div>
              </div>
            </div>
            ...
            <div class="accordion-item border-0 mb-3 rounded-3 shadow-sm overflow-hidden">
              <h2 class="accordion-header">
                <button class="accordion-button collapsed bg-white text-dark" type="button" data-bs-toggle="collapse" data-bs-target="#hsFaq2">
                  Is pest control conducted in your warehouse?
                </button>
              </h2>
              <div id="hsFaq2" class="accordion-collapse collapse" data-bs-parent="#hsFaqAccordion">
                <div class="accordion-body text-muted small">
                  Absolutely. We maintain a strict weekly pest-control schedule to ensure our warehouses are completely free from rodents, termites, and insects.
                </div>
              </div>
            </div>
          </div>
